            ...
            return (
              ...
              >
                ...
                <div className="text-right shrink-0">
                  <AnimatedPrice value={symbol.current_price} live={marketStatus.isOpen && index < 80} changePercent={symbol.change_percent ?? 0} className="text-sm font-mono font-semibold" />
