...
export const STOCK_LOGOS: Record<string, string> = {
  ...
  AKSA: `${TV}/aksa-akrilik--big.svg`,
  ARCLK: `${TV}/arcelik--big.svg`,
  ASELS: `${TV}/aselsan--big.svg`,
  BIMAS: `${TV}/bim-birlesik-magazalar--big.svg`,
  BRYAT: `${TV}/borusan-yatirim--big.svg`,
  CIMSA: `${TV}/cimsa--big.svg`,
  DOAS: `${TV}/dogus-otomotiv--big.svg`,
  DOHOL: `${TV}/dogan-holding--big.svg`,
  EKGYO: `${TV}/emlak-konut--big.svg`,
  ENKAI: `${TV}/enka-insaat--big.svg`,
  EREGL: `${TV}/eregli-demir-celik--big.svg`,
  EUPWR: `${TV}/enerjisa-enerji--big.svg`,
  FROTO: `${TV}/ford-otomotiv--big.svg`,
  GARAN: `${TV}/garanti-bankasi--big.svg`,
  GESAN: `${TV}/galata-wind-enerji--big.svg`,
  GUBRF: `${TV}/gubre-fabrikalari--big.svg`,
  HALKB: `${TV}/halkbank--big.svg`,
  ISCTR: `${TV}/is-bankasi--big.svg`,
  ISGYO: `${TV}/is-gayrimenkul--big.svg`,
  KCHOL: `${TV}/koc-holding--big.svg`,
  ...
  LOGO: `${TV}/logo-yazilim--big.svg`,
  MAVI: `${TV}/mavi-giyim--big.svg`,
  MGROS: `${TV}/migros-ticaret--big.svg`,
  ODAS: `${TV}/odas-elektrik--big.svg`,
  ...
  YKBNK: `${TV}/yapi-kredi-bankasi--big.svg`,
};
