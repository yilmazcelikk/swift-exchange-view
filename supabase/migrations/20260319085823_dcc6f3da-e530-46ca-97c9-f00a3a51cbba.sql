  ...
  LOOP
    ...
    BEGIN
      v_cs := CASE
        ...
        WHEN v_ro.symbol_name IN ('US500','US30','US100','USTEC','DE40','UK100','JP225','FR40','AU200','HK50') THEN 1
  ...
  LOOP
    ...
    IF v_net_lots > 0 AND v_net_price > 0 THEN
      v_cs := CASE
        ...
        WHEN v_sym IN ('US500','US30','US100','USTEC','DE40','UK100','JP225','FR40','AU200','HK50') THEN 1
