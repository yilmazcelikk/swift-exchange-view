DROP FUNCTION IF EXISTS public.close_position(uuid, numeric, numeric, numeric, text);
DROP FUNCTION IF EXISTS public.close_position(text, numeric, numeric, numeric, text);
